  ...
  if (UNITY_ABS (number) < epsilon)
  ...
  else
    {
      ...
      /* round to nearest integer */
      {
        ...
        if ((n & 1) && (two_n_trunc & 1)
            && !((UNITY_DOUBLE)two_n_trunc < two_number))
          n--;
#endif
      }
...
/*-----------------------------------------------*/
static void
UnityPrintFirstStringDifference (const char *expected, const char *actual,
                                 UNITY_UINT32 i_diff)
{
...
UnityPrintExpectedAndActualStringsLen (const char *expected,
                                       const char *actual, UNITY_UINT32 length,
                                       UNITY_UINT32 i_diff)
{
  UnityPrint (UnityStrExpected);
  if (expected != NULL)
...
/*-----------------------------------------------*/
void
UnityAssertEqualIntNumber (const UNITY_INT expected, const UNITY_INT actual,
...
void
UnityAssertEqualUintNumber (const UNITY_UINT expected, const UNITY_UINT actual,
                            const char *msg, const UNITY_LINE_TYPE lineNumber,
                            const UNITY_DISPLAY_STYLE_T style)
{
  RETURN_IF_FAIL_OR_IGNORE;
...
/*-----------------------------------------------*/
void
UnityAssertIntNumbersWithin (const UNITY_UINT delta, const UNITY_INT expected,
                             const UNITY_INT actual, const char *msg,
                             const UNITY_LINE_TYPE lineNumber,
                             const UNITY_DISPLAY_STYLE_T style)
{
...
/*-----------------------------------------------*/
void
UnityAssertNotEqualString (const char *expected, const char *actual,
                           const char *msg, const UNITY_LINE_TYPE lineNumber)
{
  UNITY_UINT32 i;
...
/*-----------------------------------------------*/
void
UnityAssertNotEqualStringLen (const char *expected, const char *actual,
                              const UNITY_UINT32 length, const char *msg,
                              const UNITY_LINE_TYPE lineNumber)
{
  UNITY_UINT32 i;
...
#ifdef UNITY_DETAIL_STACK_SIZE
void
UnityPushDetail (UNITY_DETAIL_LABEL_TYPE label, UNITY_DETAIL_VALUE_TYPE value,
...
void
UnityPopDetail (UNITY_DETAIL_LABEL_TYPE label, UNITY_DETAIL_VALUE_TYPE value,
                const UNITY_LINE_TYPE line)
{
