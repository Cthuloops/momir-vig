...
#define TEST_ASSERT_NOT_EQUAL_STRING_LEN(expected, actual, len)               \
  UNITY_TEST_ASSERT_NOT_EQUAL_STRING_LEN ((expected), (actual), (len),        \
                                          __LINE__, NULL)
#define TEST_ASSERT_NOT_EQUAL_MEMORY(expected, actual, len)                   \
  UNITY_TEST_ASSERT_NOT_EQUAL_MEMORY ((expected), (actual), (len), __LINE__,  \
                                      NULL)
...
#define TEST_ASSERT_NOT_EQUAL_STRING_MESSAGE(expected, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_STRING ((expected), (actual), __LINE__,         \
                                      (message))
#define TEST_ASSERT_NOT_EQUAL_STRING_LEN_MESSAGE(expected, actual, len,       \
                                                 message)                     \
  UNITY_TEST_ASSERT_NOT_EQUAL_STRING_LEN ((expected), (actual), (len),        \
                                          __LINE__, (message))
