...
bool
printer_init (struct Printer *printer, const struct PrinterSettings *settings)
{
  ...
  switch (settings->parity)
    ...
    default:
      fprintf (stderr, "Invalid value %d supplied for printer %s parity.\n",
...
bool
printer_deinit (struct Printer *printer)
{
  bool status_out = false;
