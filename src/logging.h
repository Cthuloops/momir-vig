...
#define LOG_DEBUG(module, fmt, ...)                                           \
  log_write (MOMIR_LOG_DEBUG, module, __FILE_NAME__, __func__, __LINE__, fmt, \
             ##__VA_ARGS__)
#define LOG_INFO(module, fmt, ...)                                            \
  log_write (MOMIR_LOG_INFO, module, __FILE_NAME__, __func__, __LINE__, fmt,  \
             ##__VA_ARGS__)
#define LOG_WARN(module, fmt, ...)                                            \
  log_write (MOMIR_LOG_WARN, module, __FILE_NAME__, __func__, __LINE__, fmt,  \
             ##__VA_ARGS__)
#define LOG_ERROR(module, fmt, ...)                                           \
  log_write (MOMIR_LOG_ERROR, module, __FILE_NAME__, __func__, __LINE__, fmt, \
             ##__VA_ARGS__)
#define LOG_FATAL(module, fmt, ...)                                           \
  log_write (MOMIR_LOG_FATAL, module, __FILE_NAME__, __func__, __LINE__, fmt, \
             ##__VA_ARGS__)
